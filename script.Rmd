...
```
Through observation, one can notice that people aged 75 years or older have the highest suicide rate and the rate decreases as we go down the age groups.
...
```
It appears that the suicide rate difference amongst men and females is positive. We find that this difference is positive in all cases.
...
```
As one can notice, the "Silent" generation was the one that saw most number of suicides across the globe. 
